...
public class AlquilerLargoPlazo extends Alquiler {
	...
	public AlquilerLargoPlazo(Cliente cliente, Vehiculo vehiculo, String fechaInicio, String fechaFin, double precioMensual, double descuentoLargoPlazo) {
	...
	public String toString() {
	 ...
	 @Override
	    public double calcularPrecio() {
	        return precioMensual * this.calcularMeses() - descuentoLargoPlazo;
	    }
}
